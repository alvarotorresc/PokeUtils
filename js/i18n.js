...
const translations = {
  es: {
    ...
    'meta.tera': 'Tera',
    'meta.tera.none': 'No teracristaliza',
    ...
    'meta.family': 'No se juega en ningún formato medido. El de su línea evolutiva que sí se juega es {name}:',
    ...
    'moves.col.type': 'TIPO',
    'moves.col.cat': 'CATEGORÍA',
    'moves.col.pow': 'POTENCIA',
    'moves.col.acc': 'PRECISIÓN',
    // PP se queda: son las siglas del propio juego en los dos idiomas, y no hay
    // palabra entera que ponga en su lugar.
    'moves.col.pp': 'PP',
    ...
    'moves.filter.stat.allopt': 'Cualquier estadística',
