...
const translations = {
  es: {
    ...
    'survive.assumption': 'Nivel {level}, atacante a maxima inversion, defensor sin invertir',
    ...
    'search.kind.move': 'MOV',
    'search.kind.ability': 'HAB',
    'search.kind.item': 'OBJ',
    'pokedex.type': 'TIPO',
    ...
    'capture.subtitle': 'Probabilidad de capturar y cuantas balls te hacen falta',
    'capture.target': 'Objetivo',
    'capture.situation': 'Situacion',
    'capture.ball': 'Ball',
    ...
    'cond.caught': 'Ya lo tienes en la Pokedex',
    ...
    // Damage calculator
    'calc.tab.damage': 'DANO',
    'home.damage.desc': 'Cuanto dano hace un movimiento y si llega al KO',
    'dmg.title': 'Calculadora de Dano',
    'dmg.subtitle': 'Rango de dano, porcentaje de PS y golpes para el KO',
    'dmg.attacker': 'Atacante',
    'dmg.defender': 'Defensor',
    'dmg.move': 'Movimiento',
    'dmg.movesearch': 'Buscar movimiento de dano...',
    'dmg.field': 'Campo y modificadores',
    'dmg.weather': 'Clima',
    'dmg.terrain': 'Terreno',
    'dmg.screen': 'Pantalla',
    'dmg.crit': 'Golpe critico',
    ...
    'terrain.electric': 'Campo Electrico',
    'terrain.grassy': 'Campo de Hierba',
    'terrain.psychic': 'Campo Psiquico',
    ...
    'vp.in.damagetaken': 'Dano recibido',
    ...
    'vp.fixed': 'Dano fijo: ignora tipos, STAB y defensa',
    ...
    'vp.unsupported.xd': 'Solo existe en Pokemon Colosseum y XD',
    ...
    'vp.endeavor.above': 'No hace nada si tienes mas PS que el rival',
    ...
    'team.subtitle': 'Debilidades combinadas y cobertura de hasta 6 Pokemon',
    'team.search': 'Anadir Pokemon al equipo...',
    'team.notfound': 'Ningun Pokemon con ese nombre',
    'team.remove': 'Quitar del equipo',
    'team.empty': 'Anade Pokemon para ver de que se defiende mal tu equipo y que tipos no puedes tocar',
    'team.defense': 'DEFENSA',
    'team.threats': 'Amenazas: golpean a la mitad del equipo o mas',
    'team.threats.none': 'Ningun tipo golpea a tres o mas miembros',
    'team.unresisted': 'Sin respuesta: nadie del equipo lo resiste',
    'team.unresisted.none': 'Todo lo que os golpea lo resiste alguien',
    'team.col.type': 'TIPO',
    'team.offense': 'ATAQUE',
    'team.offense.hint': 'Los tipos de tu equipo estan fijos. Anade los tipos de los movimientos de cobertura que pienses llevar.',
    'team.atk.stab': 'Tipo propio del equipo',
    'team.super': 'Golpeas x2 o mas',
    'team.super.none': 'No golpeas con ventaja a ningun tipo',
