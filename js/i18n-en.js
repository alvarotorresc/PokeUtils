...
export default {
    ...
    'faq.spanish.a': 'From the games\' official text, gathered from WikiDex, Bulbapedia and pkproject.net. Every entry documents its source right in the code. Eight descriptions have no such backing —the move torque, two Poke Balls with no official text, and one placeholder item— and are written by PokeUtils, marked as such.',
