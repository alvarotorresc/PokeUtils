...
export default {
    ...
    'faq.data.a': 'From PokeAPI, the public REST API that gathers the games\' data.',
    'faq.meta.q': 'And the competitive sets?',
    'faq.meta.a': 'From Smogon\'s usage statistics, for the OU and VGC formats. It is a snapshot from July 2026: it does not update itself, it gets regenerated by hand when it is due.',
    'faq.spanish.q': 'PokeAPI does not have everything in Spanish. Where does that text come from?',
    'faq.spanish.a': 'From the games\' official text, gathered from WikiDex, Bulbapedia and pkproject.net. Every entry documents its source right in the code. Eight descriptions have no such backing —the five Revavroom "torque" moves, two Poke Balls with no official text, and one item with a provisional description— and are written by PokeUtils, marked as such.',
    'faq.megastones.q': 'What about the Spanish names for the Mega Stones from Legends Z-A and Pokemon Champions?',
    'faq.megastones.a': 'There is no official name yet, so they are worked out by hand following the pattern the series already uses for every other Mega Stone, until Nintendo publishes its own.',
    'faq.scvi.q': 'Scarlet and Violet sometimes tell a different story about the same Pokemon. Which one wins?',
    'faq.scvi.a': 'Scarlet\'s, whenever they differ.',
    'faq.sprites.q': 'Where do the sprites come from?',
    'faq.sprites.a': 'They are served from this site itself, not from a third party.',
    'faq.missing.q': 'Why can a piece of data be missing or wrong?',
    'faq.missing.a': 'Because the games keep changing. The data gets regenerated every so often, and automated checks review that it still adds up, but something can still slip through.',

    'privacy.title': 'Privacy',
    'privacy.subtitle': 'What gets stored, and where',
    'privacy.accounts.title': 'No accounts, no sign-up',
    'privacy.accounts.body': 'There is no account to create and nothing to hand over to use PokeUtils. Analytics run on Umami, self-hosted by the author: no cookies, no personal identifiers, just aggregate visit counts.',
    'privacy.storage.title': 'What your browser keeps',
    'privacy.storage.body': 'Language, theme and search history are saved only in your own browser, with localStorage. They never leave it: nothing gets sent to any server.',
    'privacy.ads.title': 'No ads, no third parties',
    'privacy.ads.body': 'No ads, and nobody tracking you from site to site.',

    'terms.title': 'Terms',
    'terms.subtitle': 'The essentials, no fine print',
    'terms.asis.title': 'Used as-is',
    'terms.asis.body': 'PokeUtils is provided as-is, with no warranties. It is a free tool made by an independent developer, not a company.',
    'terms.disclaimer.title': 'A fan project',
    'terms.disclaimer.body': 'PokeUtils is not affiliated with, endorsed by, or supported by Nintendo, Creatures Inc., GAME FREAK or The Pokemon Company. Pokemon and the names of the games and creatures are trademarks of their respective owners; game data belongs to its owners and is shown here for informational purposes.',
    'terms.license.title': 'The code',
    'terms.license.body': 'The site\'s code is MIT-licensed: read it, copy it, adapt it. It lives in {link}.',
    'terms.license.link': 'the repository',
