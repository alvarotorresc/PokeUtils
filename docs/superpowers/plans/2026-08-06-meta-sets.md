...
- [ ] **Step 3: Escribir `scripts/build-meta.mjs`**
...
- [ ] **Step 4: Pasar el builder contra un directorio aparte**
...
- [ ] **Step 6: Añadir `fetchMeta` a `js/api.js`**
...
- [ ] **Step 3: Commit** (junto con la Task 1, ver su Step 8)
...
- [ ] **Step 1: Escribir `js/meta-page.js`**
...
- [ ] **Step 2: Registrar la ruta en `js/app.js`**
...
- [ ] **Step 3: Registrar la herramienta en `js/tools.js`**
...
- [ ] **Step 1: Cargar el meta y pintar la sección**
...
- [ ] **Step 1: `threats.js` acepta el índice**
...
- [ ] **Step 2: `counter.js` carga el meta y marca las filas**
...
- [ ] **Step 4: Actualizar `scripts/check-counter.mjs`**
...
- [ ] **Step 1: Los once scripts en verde**
