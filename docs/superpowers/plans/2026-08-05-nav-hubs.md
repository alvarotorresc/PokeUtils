...
- [x] **Step 3: Añadir las claves nuevas a `js/i18n.js`**
...
- [x] **Step 2: Enchufar las dos rutas en `js/app.js`**
...
- [x] **Step 3: Comprobarlo en el navegador con recarga real**
...
- [x] **Step 1: Reescribir `js/home.js`**
...
- [x] **Step 2: Dar estilo al encabezado de grupo**
...
- [x] **Step 3: Comprobarlo en el navegador**
...
- [x] **Step 1: Dejar la barra en cuatro enlaces**
...
- [x] **Step 2: Que las etiquetas y los destinos salgan de la tabla**
...
- [x] **Step 3: Encender la pestaña por categoría, no por página**
...
- [x] **Step 4: Llamarla una sola vez en `route()`**
...
- [x] **Step 5: Comprobar los cinco casos en el navegador**
...
- [x] **Step 1: Los scripts de comprobación siguen en verde**
...
- [x] **Step 2: Las 12 rutas responden**
...
Esperado: **618 - 728**, "KO seguro en 1", con la casilla de crítico marcada. Es
el mismo valor que daba antes de tocar la navegación, comprobado sirviendo el
commit previo en paralelo.

(Este paso decía **168 - 198** al escribir el plan. Ese número es del ejemplo de
`check-damage.mjs` — Glaceon nivel 75 con Colmillo Hielo, 168 a 196 — y no de
esta URL, que es Charizard nivel 100 con Lanzallamas sobre Venusaur.)

Y `#/team?ids=3,6,9` tiene que seguir cargando sus tres miembros.

- [x] **Step 4: La barra ya no se corta**
...
- [x] **Step 6: Consola limpia**

Cero errores y cero avisos en toda la sesión de pruebas.

- [x] **Step 7: Commit de lo que se haya corregido**
